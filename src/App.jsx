...
const QUERIES=[
  // USA vs IRAN — Primary focus
  "USA Iran military strike attack today",
  "US strikes Iran targets Iraq Syria today",
  "Iran attack US military base troops today",
  "Trump Iran war strike bombing today",
  "US Navy Iran Persian Gulf confrontation today",
  "Iran nuclear facility strike Israel USA today",
  "Houthi Red Sea ship attack US Navy strike Yemen today",
  "Iran proxy militia attack US forces Iraq Syria today",
  "Iran IRGC military operation retaliation USA today",
  "Israel Iran airstrike missile exchange today",
  // Secondary theaters
  "Ukraine Russia frontline battle drone strike today",
  "North Korea missile launch ICBM nuclear test today",
];
